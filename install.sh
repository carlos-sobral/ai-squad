...
echo "     → ativa o shadcn registry MCP (props reais de componentes, sem alucinacao)"
echo "  3. Open Claude Code inside your project folder"
echo "  4. Type: /sdlc-orchestrator"
echo ""
echo "Design tooling opcional (ver templates/design-tooling.md):"
echo "  - ui-ux-pro-max (acelerador do Design System Mode):"
