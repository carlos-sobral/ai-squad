...
### Spec completeness checklist — additions (internal events + visual-contract deps)
...
### Spec completeness checklist — additions (type unions + cleanup scope)
...
### Spec completeness checklist — additions (persistence + config hardening)
...
### Spec completeness checklist — additions (native-runtime + multi-pipeline)
...
### Risk Surface taxonomy — additions (native-runtime IPC + cross-pipeline)
...
### Spec completeness checklist — additions (capability-gated plugins + version detection)
...
### Spec completeness checklist — additions (refactor ACs + env prerequisites)
...
### Spec completeness checklist — additions (self-identity topologies)
